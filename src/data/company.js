...
export const aboutUs = {
  mission: "To provide high-quality chemicals and exceptional service to industries worldwide while maintaining the highest standards of safety and environmental responsibility.",
  vision: "To be the leading chemical distributor in India, known for reliability, quality, and innovation.",
  values: [
    "Quality Excellence",
  ...
  experience: "8+ years of experience in chemical distribution",
...
export const services = [
  {
    ...
    description: "Reliable distribution of industrial chemicals to various sectors",
    icon: "local_shipping"
  },
  {
    id: 2,
    title: "Quality Assurance",
    description: "Rigorous quality control and testing for all products",
    icon: "verified"
  },
  {
    id: 3,
    title: "Technical Support",
    description: "Expert technical guidance and product consultation",
    icon: "support_agent"
  },
  {
    id: 4,
    title: "Custom Solutions",
    description: "Tailored chemical solutions for specific industrial needs",
    icon: "build"
  }
];
